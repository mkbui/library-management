...
const Taskbar = () => {
    return (
<nav className="flex justify-between bb b--white-10 bg-light-yellow">
  ...
  <div className="flex-grow pa3 flex items-center">
    <a className="f6 link dib white dim mr3 mr4-ns bg-dark-gray" href="#0">About</a>
    <a className="f6 link dib white dim mr3 mr4-ns bg-dark-gray" href="#0">Sign In</a>
